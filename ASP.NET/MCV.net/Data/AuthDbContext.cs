    ...
    public class AuthDbContext : IdentityDbContext  
    {
       public DbSet<Project> projects {  get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
           ...
           new Category { categoryId = 4, category = "Commercial" 
           
           }
       );
        }
        public DbSet<MCV.net.Models.ForgetPassword> ResetPassword { get; set; }
        public DbSet<MCV.net.Models.ResetPassword> ResetPassword_1 { get; set; }
        public DbSet<MCV.net.Models.ContactModel> ContactModel { get; set; }
    }
}

...
namespace MCV.net.Controllers
{
    public class AccountController : Controller
    {
     ...
     private readonly IWebHostEnvironment _env;
        ...
        public AccountController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, ApplicationDbContext db, AuthDbContext adb, EmailSender emailSender, IWebHostEnvironment env)
        {
